...
// import WebSiteType from './website.js'
// import PersonOfficeType from './personOffice.js'
...
module.exports = new GraphQLObjectType({
    ...
    fields () {
        return {
            ...
            countryDescription: {
                type: GraphQLString,
                description: "Primary address country description",
                resolve (office) {
                    return office.countryDescription;
                }
            }//,
            // phones: {
            ...
            // },
            // personOffice: {
            //   type: new GraphQLList(PersonOfficeType),
            //     description: "The list of related personOffices",
            //     resolve(office) {
            //       return office.getPersonOffices();
            //     }
            // }
        };
    }
